...
on 2020-11-15 19:02:15. The code is partially based on the PsychoPy Builder compiler code and demos.
...
Peirce J, Gray JR, Simpson S, MacAskill M, Hhenberger R, Sogo H, Kastman E, Lindev JK. (2019)
...
execute_test(Stroop_2, Stroop_components, practice=True)
execute_screen(Real, Real_3, 0.0)
execute_test(Stroop_4, Stroop_components, random=True)
