...
on 2020-11-15 14:24:21. The code is partially based on the PsychoPy Builder compiler code and demos.
...
Peirce J, Gray JR, Simpson S, MacAskill M,  JK. (2019)
...
Intro = visual.TextStim(win=win, name='Intro', height=0.08,
    text=r'''Press LEFT for the RED color

    Press DOWN for the GREEN color

    Press RIGHT for the BLUE color

    Press UP for the YELLOW color

''')


# Content for screen Intro
Intro_1 = r'''Press LEFT for the RED color
    Press DOWN for the GREEN color
    Press RIGHT for the BLUE color
    Press UP for the YELLOW color'''

# Trial component settings for Stroop test
Stroop_2 = [
       # Trial 1
      {'vars': {'word': 'red',
            'color': 'red',
...
execute_test(Stroop_2, Stroop_components, random=True)
